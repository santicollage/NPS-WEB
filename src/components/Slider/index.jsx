    ...
    <div className="slider-container">
      ...
      >
        ...
        <div className="slider-text">
          ...
          <p className="text">
            Su vehículo merece lo mejor: Más de 30 marcas líderes en repuestos,
            calidad y confianza al alcance de su mano.
          </p>
      ...
      >
        <div className="slider-text">
          ...
          <p className="text">
            Visítenos en nuestra sede principal, ubicada en la zona comercial de
            mayor cobertura, Estanzuel, Los Martires, Bogota.
          </p>
          <button
